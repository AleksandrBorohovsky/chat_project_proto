...
type LoginRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Email         string                 `protobuf:"bytes,1,opt,name=email,proto3" json:"email,omitempty"`       // Email of the user to log in.
	Password      string                 `protobuf:"bytes,2,opt,name=password,proto3" json:"password,omitempty"` // Password of the user to log in.
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_user_user_proto_rawDesc = "" +
	...
	"\x06Logout\x12\x13.user.LogoutRequest\x1a\x14.user.LogoutResponseB8Z6github.com/aleksandrborohovsky/chat_project_proto/userb\x06proto3"
...
var file_user_user_proto_depIdxs = []int32{
	...
	5, // 5: user.User.Logout:output_type -> user.LogoutResponse
